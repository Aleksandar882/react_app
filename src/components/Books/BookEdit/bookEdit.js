                    ...
                    <div className="form-group">
                        ...
                        <select name="category" className="form-control" onChange={handleChange}>
                            {props.categories.map((term) => {
                                if(props.categories.category !== undefined){
                                    return <option selected={props.categories.category} value={term.category}>{term.category}</option>
                                }
                                else return <option value={term.category}>{term.category}</option>
                            })}
                        </select>
                    </div>
                    <div className="form-group">
